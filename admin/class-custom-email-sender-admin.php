...
class Custom_Email_Sender_Admin
{
	...
	*/
	...
	{
		$html = '<div class="wpdx-header"><span class="header-icon"><i class="fas fa-sliders-h"></i></span> <span class="header-text">'.__('Custom Email Sender', 'custom-email-sender').'</span></div>';
		return $html;
	}
