...
Custom Email Sender allows you to easily customize the default email sender name and default email address directly from your WordPress dashboard.

* * *

## Installation

1. Upload the **`custom-email-sender`** folder to the **`/wp-content/plugins/`** directory.  
...
- Updated main CSS files `dashboard.css` and `standalone.css`  
...
- Removed unnecessary assets (`images/`, `styles/datatables.min.css`)  
- Updated variables in `admin/class-custom-email-admin.php`  
- Fixed bug in loader process  
...
- Updated translations (Spanish, French)  

### 1.9.3 (2019-06-12)

- Changed process of updating the database  
- Added FontAwesome icons  
- Improved CSS/JS loader (load only in plugin section)  
